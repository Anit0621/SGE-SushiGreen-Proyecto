...
from app.models.clientes import (obtener_clientes, filtrar_clientes, crear_cliente,
                                 obtener_todos, eliminar_cliente, actualizar_cliente)
...
def actualizado_cliente(cedula_cliente,nombre,apellido,telefono,tipo_documento,habeas_data,ciudad,direccion_residencia,direccion_operativa,
                       email,representante_legal,regimen_tributario):
    actualizar_cliente(cedula_cliente,nombre,apellido,telefono,tipo_documento,habeas_data,ciudad,direccion_residencia,direccion_operativa,
                       email,representante_legal,regimen_tributario)